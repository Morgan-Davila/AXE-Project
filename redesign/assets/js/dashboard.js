// AI made
// Bootstrap de la page Dashboard du prototype.
// Cocher une habitude ici ne modifie QUE une copie en mémoire (aucun
// localStorage.setItem) : c'est une démonstration d'interaction, pas une
// vraie persistance.
...
import { getHabits, classifyToday, streakTier, computeDailyCompletions } from "./data.js";
...
if (previewNote) {
    previewNote.querySelector("span").textContent = isDemo
        ...
        : "Vos habitudes réelles sont affichées en lecture seule : cocher une case ici ne modifie pas vos données enregistrées.";
}
